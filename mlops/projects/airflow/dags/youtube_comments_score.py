...
args = {
    "owner": "admin",
    "start_date": dt.datetime(2023, 1, 14),
    "retries": 2,
...
with DAG(
    ...
    get_data = BashOperator(task_id='get_data',
                            bash_command="python3 /home/mlops/project/scripts/get_data.py",
                            dag=dag)
    process_data = BashOperator(task_id='process_data',
                            bash_command="python3 /home/mlops/project/scripts/data_processing.py",
                            dag=dag)
    train_test_split_data = BashOperator(task_id='train_test_split_data',
                            bash_command="python3 /home/mlops/project/scripts/train_test_split.py",
                            dag=dag)  
    train_model = BashOperator(task_id='train_model',
                            bash_command="python3 /home/mlops/project/scripts/train_model.py",
                            dag=dag)
    test_model = BashOperator(task_id='test_model',
                            bash_command="python3 /home/mlops/project/scripts/test_model.py",
                            dag=dag)
